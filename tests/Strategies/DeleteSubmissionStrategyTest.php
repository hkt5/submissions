...
class DeleteSubmissionStrategyTest extends TestCase
{
    use WithoutEvents;
    ...
    public function testDeleteSubmission() : void
    {
        ...
        $data = [
            'method' => 'delete', 'uri' => '/delete/submission', 'parameters' => $userTypeData 
    ...
    {
        // given
        $userTypeData = ['id' => 25421];

        $data = [
            'method' => 'post', 'uri' => '/delete/submission', 'parameters' => $userTypeData 
    ...
    public function testDeleteSubmissionThatIsNotInteger() : void
    {
        // given
        $userTypeData = ['id' => "I am not integer"];
